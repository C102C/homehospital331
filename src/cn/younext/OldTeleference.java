...
public class OldTeleference extends BaseActivity {
	Button homeBtn;
	Button personBtn1;
	Button personBtn2;
	Button personBtn3;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.teleference_old);		
...
//		}
		...
		helper = new DatabaseHelper(OldTeleference.this,
		...
		btnClick = new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (v == homeBtn) {
					...
					Intent i = new Intent();
					i.putExtra("_id", "1");
					i.setClass(OldTeleference.this, teleference_xiugaidialog.class);
