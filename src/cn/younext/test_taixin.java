...
public class test_taixin extends Activity{
	Button homeBtn;
	Button returnBtn;
	Button nextBtn;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test_taixin);
        ...
        user=(TextView)findViewById(R.id.test_taixin_user);
        user.setText(getString(R.string.myhealth_Welcome)+username);
        
        homeBtn = (Button)findViewById(R.id.test_taixin_homeBtn);
        returnBtn=(Button)findViewById(R.id.test_taixin_returnBtn);
        nextBtn=(Button)findViewById(R.id.test_taixin_nextBtn);
        btnClick= new OnClickListener(){
    		@Override
    		public void onClick(View v) {

        		if(v==homeBtn){      		
    			    test_taixin.this.setResult(RESULT_OK);
    		        test_taixin.this.finish();
        		}
        		else if(v==returnBtn){
        			test_taixin.this.finish();	
        		}
        			...
        			Intent i = new Intent();
        			i.setClass(test_taixin.this, test_taixin1.class);
