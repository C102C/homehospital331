...
public class test_zhifang extends Activity{
	Button homeBtn;
	Button returnBtn;
	Button nextBtn;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test_zhifang);
        ...
        user=(TextView)findViewById(R.id.test_zhifang_user);
        user.setText(getString(R.string.myhealth_Welcome)+username);
        
        homeBtn = (Button)findViewById(R.id.test_zhifang_homeBtn);
        returnBtn=(Button)findViewById(R.id.test_zhifang_returnBtn);
        nextBtn=(Button)findViewById(R.id.test_zhifang_nextBtn);
        btnClick= new OnClickListener(){
    		@Override
    		public void onClick(View v) {

        		if(v==homeBtn){      		
    			    test_zhifang.this.setResult(RESULT_OK);
    		        test_zhifang.this.finish();
        		}
        		else if(v==returnBtn){
        			test_zhifang.this.finish();	
        		}
        			...
        			Intent i = new Intent();
        			i.setClass(test_zhifang.this, test_zhifang1.class);
