...
public class test_xueyang1 extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test_xueyang1);
        ...
        user=(TextView)findViewById(R.id.test_xueyang1_user);
        user.setText(getString(R.string.myhealth_Welcome)+username);
        
        homeBtn = (Button)findViewById(R.id.test_xueyang1_homeBtn);
        returnBtn=(Button)findViewById(R.id.test_xueyang1_returnBtn);
        ...
        btnClick= new OnClickListener(){
    		...
    		public void onClick(View v) {
        		...
        		if(v==homeBtn){      		
    			    test_xueyang1.this.setResult(RESULT_OK);
    		        test_xueyang1.this.finish();
        		}
        		else if(v==returnBtn){
        			test_xueyang1.this.finish();	
        		}
