...
public class test_taixin1 extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test_taixin1);
        ...
        user=(TextView)findViewById(R.id.test_taixin1_user);
        user.setText(getString(R.string.myhealth_Welcome)+username);
        
        homeBtn = (Button)findViewById(R.id.test_taixin1_homeBtn);
        returnBtn=(Button)findViewById(R.id.test_taixin1_returnBtn);
        ...
        btnClick= new OnClickListener(){
    		...
    		public void onClick(View v) {
        		...
        		if(v==homeBtn){      		
    			    test_taixin1.this.setResult(RESULT_OK);
    		        test_taixin1.this.finish();
        		}
        		else if(v==returnBtn){
        			test_taixin1.this.finish();	
        		}
