...
public class calendar_drug extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.calendar_drug);
        ...
        helper = new DatabaseHelper(calendar_drug.this, DatabaseHelper.DATABASE_NAME, null,DatabaseHelper.Version);     
        db = helper.getWritableDatabase();
        c=db.query(DatabaseHelper.ALARMTABLE, null, DatabaseHelper.ID+">5", null, null, null, DatabaseHelper.ID+" asc");
 
   
        
        
        c.moveToNext();     
        initialize(this, c,xuanzhongBtn1, drug_edit1,clockBtn1,drug_spinner1,drug_spinnertext1,"6");
        c.moveToNext();     
        initialize(this, c,xuanzhongBtn2, drug_edit2,clockBtn2,drug_spinner2,drug_spinnertext2,"7");
        c.moveToNext();     
        initialize(this, c,xuanzhongBtn3, drug_edit3,clockBtn3,drug_spinner3,drug_spinnertext3,"8");
        c.moveToNext();     
        initialize(this, c,xuanzhongBtn4, drug_edit4,clockBtn4,drug_spinner4,drug_spinnertext4,"9");
        c.moveToNext();     
        initialize(this, c,xuanzhongBtn5, drug_edit5,clockBtn5,drug_spinner5,drug_spinnertext5,"10");
        ...
        btnClick= new OnClickListener(){
    		...
    		public void onClick(View v) {
        		...
        		if(v==homeBtn){   
					...
					values.put(DatabaseHelper.TEXT, medical_edit1.getText().toString());//key为字段名，value为值
    ...
    public static void initialize(Context context, Cursor c, Button xuanzhongBtn, EditText medical_edit, Button clockBtn, Spinner medical_spinner,final TextView medical_spinnertext,final String id){
         ...
         final Cursor c1=db.query(DatabaseHelper.ALARMZHOUQITABLE, null, null, null, null,null,"_id asc",null);//用户名字查询
    ...
    public static void alarmTimeSet(final Context context, String id,int alarmid, EditText medical_edit){
		...
		if(c.getInt(1)==0){
	    	...
	    	intent.putExtra("tishi", context.getString(R.string.calendar_drug_tishi));
