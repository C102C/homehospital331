...
public class test_xuetang1 extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test_xuetang1);
        ...
        user=(TextView)findViewById(R.id.test_xuetang1_user);
        user.setText(getString(R.string.myhealth_Welcome)+username);
        
        homeBtn = (Button)findViewById(R.id.test_xuetang1_homeBtn);
        returnBtn=(Button)findViewById(R.id.test_xuetang1_returnBtn);
        ...
        btnClick= new OnClickListener(){
    		...
    		public void onClick(View v) {
        		...
        		if(v==homeBtn){      		
    			    test_xuetang1.this.setResult(RESULT_OK);
    		        test_xuetang1.this.finish();
        		}
        		else if(v==returnBtn){
        			test_xuetang1.this.finish();	
        		}
