...
public class test_xueyang extends Activity{
	Button homeBtn;
	Button returnBtn;
	Button nextBtn;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test_xueyang);
        ...
        user=(TextView)findViewById(R.id.test_xueyang_user);
        user.setText(getString(R.string.myhealth_Welcome)+username);
        
        homeBtn = (Button)findViewById(R.id.test_xueyang_homeBtn);
        returnBtn=(Button)findViewById(R.id.test_xueyang_returnBtn);
        nextBtn=(Button)findViewById(R.id.test_xueyang_nextBtn);
        btnClick= new OnClickListener(){
    		@Override
    		public void onClick(View v) {

        		if(v==homeBtn){      		
    			    test_xueyang.this.setResult(RESULT_OK);
    		        test_xueyang.this.finish();
        		}
        		else if(v==returnBtn){
        			test_xueyang.this.finish();	
        		}
        			...
        			Intent i = new Intent();
        			i.setClass(test_xueyang.this, test_xueyang1.class);
