...
public class test_xuetang extends Activity{
	Button homeBtn;
	Button returnBtn;
	Button nextBtn;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test_xuetang);
        ...
        homeBtn = (Button)findViewById(R.id.test_xuetang_homeBtn);
        returnBtn=(Button)findViewById(R.id.test_xuetang_returnBtn);
        nextBtn=(Button)findViewById(R.id.test_xuetang_nextBtn);
        btnClick= new OnClickListener(){
    		@Override
    		public void onClick(View v) {

        		if(v==homeBtn){      		
    			    test_xuetang.this.setResult(RESULT_OK);
    		        test_xuetang.this.finish();
        		}
        		else if(v==returnBtn){
        			test_xuetang.this.finish();	
        		}
        			...
        			Intent i = new Intent();
        			i.setClass(test_xuetang.this, test_xuetang1.class);
