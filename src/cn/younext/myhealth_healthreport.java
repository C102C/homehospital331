...
public class myhealth_healthreport extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {    
         ...
         //DigitalClock mDigitalClock=(DigitalClock)findViewById(R.id.myhealth_healthreport_digitalclock);
        ...
        helper = new DatabaseHelper(this, DatabaseHelper.DATABASE_NAME, null,DatabaseHelper.Version);     
         ...
         if(gaoya!=""&&diya!=""){
        	 xueyaText.setText(getString(R.string.myhealth_healthreport_gaoya)+String.valueOf(gaoya)+"\n"+getString(R.string.myhealth_healthreport_diya)+String.valueOf(diya));
         }
         else{
     ...
     //    detail = (Button)findViewById(R.id.historyBtn);
      ...
      /*   		else if(v==detail){
         			i.setClass(myhealth_healthreport.this, history_report.class);
        			...
        			startActivityForResult(i,1);
         	         ...
         	         if(expert_xueya!=null){
         	        	...
         	        	expertText.setText(getString(R.string.myhealth_healthreport_expertempty));
         	         }
         		}
         		else if(v==mailvbtn){
