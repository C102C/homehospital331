...
public class healthreport_alarm extends BroadcastReceiver{
	...
	public void onReceive(Context context, Intent intent) {
        ...
        c=db.query(DatabaseHelper.HISTORY_REPORT, null, null, null, null,null,"_id desc",null);//用户名字查询
        c.moveToNext();
        myear=c.getInt(10);
        mmonth=c.getInt(11);
        mday=c.getInt(12);
        ...
        else if(yestoday_month==2||yestoday_month==4||yestoday_month==6||yestoday_month==8||yestoday_month==9||yestoday_month==11){
        	yestoday_month=yestoday_month-1;
        	yestoday_day=31;
        }
        else if(yestoday_month==5||yestoday_month==7||yestoday_month==10||yestoday_month==12){
        	yestoday_month=yestoday_month-1;
        	yestoday_day=30;
        }
        ...
        if(myear==yestoday_year&&mmonth==yestoday_month&&mday==yestoday_day){
        	...
        	try{
        		...
        		if(client.record.bp == null){
        		    ...
        		    values.put(DatabaseHelper.HISTORY_REPORT_EXPERT_XUEYA, client.record.bpAdvice);
        		
        		}
        		if(client.record.bo==null){
        			values.put(DatabaseHelper.HISTORY_REPORT_XUEYANG,"");
        			values.put(DatabaseHelper.HISTORY_REPORT_EXPERT_XUEYANG,"");
        		}
        		else{
        			k=true;
        			String[]bp = client.record.bo.split(" ");
        		    values.put(DatabaseHelper.HISTORY_REPORT_XUEYANG,bp[0]);   
        		    values.put(DatabaseHelper.HISTORY_REPORT_EXPERT_XUEYANG,client.record.boAdvice);
        		}
        		if(client.record.fat==null){
        			values.put(DatabaseHelper.HISTORY_REPORT_ZHIFANGLV,"");
        			values.put(DatabaseHelper.HISTORY_REPORT_EXPERT_ZHIFANGLV,"");
        		}
        		else{
        			k=true;
        			String[]bp = client.record.fat.split(" ");
        		    values.put(DatabaseHelper.HISTORY_REPORT_ZHIFANGLV,bp[0]);   
        		    values.put(DatabaseHelper.HISTORY_REPORT_EXPERT_ZHIFANGLV,client.record.fatAdvice);
        			
        		}
        		if(client.record.glu==null){
        			values.put(DatabaseHelper.HISTORY_REPORT_XUETANG,"");
        			values.put(DatabaseHelper.HISTORY_REPORT_EXPERT_XUETANG,"");
        		}
        		else{
        			k=true;
        			String[]bp = client.record.glu.split(" ");
        		    values.put(DatabaseHelper.HISTORY_REPORT_XUETANG,bp[0]);   
        		    values.put(DatabaseHelper.HISTORY_REPORT_EXPERT_XUETANG,client.record.gluAdvice);
        		}
        		if(client.record.heart==null){
        		    ...
        		    values.put(DatabaseHelper.HISTORY_REPORT_EXPERT_TAIXIN,client.record.heartAdvice);
        		}
        		if(client.record.pulse==null){
        		    ...
        		    values.put(DatabaseHelper.HISTORY_REPORT_EXPERT_MAILV,client.record.pulseAdvice);
        		}
        		if(client.record.temperature==null){
        		    ...
        		    values.put(DatabaseHelper.HISTORY_REPORT_EXPERT_TIWEN, client.record.temperatureAdvice);
        		}
        		if(client.record.weight==null){
        			values.put(DatabaseHelper.HISTORY_REPORT_TIZHONG,"");
        			values.put(DatabaseHelper.HISTORY_REPORT_EXPERT_TIZHONG,"");
        		}
        		else{
        			k=true;
        			String[]bp = client.record.weight.split(" ");
        		    values.put(DatabaseHelper.HISTORY_REPORT_TIZHONG,bp[0]);   
        		    values.put(DatabaseHelper.HISTORY_REPORT_EXPERT_TIZHONG,client.record.weightAdvice);
        		}
        		...
        		if(k==true){
        			...
        			Intent i = new Intent(context, healthreport_alarmalert.class);
