...
public class Decoder
{
	class LenDecoder
	{
		...
		public void Init()
		{
			RangeCoderDecoder.InitBitModels(m_Choice);
	...
	class LiteralDecoder
	{
		class Decoder2
		{
			...
			public void Init()
			{
				RangeCoderDecoder.InitBitModels(m_Decoders);
			}
	...
	void Init() throws IOException
	{
		...
		RangeCoderDecoder.InitBitModels(m_IsMatchDecoders);
		RangeCoderDecoder.InitBitModels(m_IsRep0LongDecoders);
		RangeCoderDecoder.InitBitModels(m_IsRepDecoders);
		RangeCoderDecoder.InitBitModels(m_IsRepG0Decoders);
		RangeCoderDecoder.InitBitModels(m_IsRepG1Decoders);
		RangeCoderDecoder.InitBitModels(m_IsRepG2Decoders);
		RangeCoderDecoder.InitBitModels(m_PosDecoders);
